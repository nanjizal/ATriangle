...
Empty.prototype = {
	...
	,render: function(framebuffer) {
		...
		g2.begin();
		g2.set_color(-65536);
		g2.fillTriangle(100,100,200,200,100,300);
		g2.end();
	}
	,__class__: Empty
};
...
Main.__name__ = true;
Main.main = function() {
	kha_System.init({ title : "Empty", width : 800, height : 600},function() {
		new Empty();
	});
};
Math.__name__ = true;
...
$hxClasses["TriangleTest"] = TriangleTest;
TriangleTest.__name__ = true;
TriangleTest.redTriangle = function(g2) {
	g2.begin();
	g2.set_color(-65536);
	g2.fillTriangle(100,100,200,200,100,300);
	g2.end();
