...
Main.prototype = $extend(luxe_Game.prototype,{
	ready: function() {
		var shape = new phoenix_geometry_Geometry({ primitive_type : 4, batcher : Luxe.renderer.batcher});
		var color = new phoenix_Color().rgb(16711680);
		shape.add(new phoenix_geometry_Vertex(new phoenix_Vector(100,100),color));
		shape.add(new phoenix_geometry_Vertex(new phoenix_Vector(200,200),color));
		shape.add(new phoenix_geometry_Vertex(new phoenix_Vector(100,300),color));
	}
	,onmousemove: function(event) {
	}
	,onkeyup: function(e) {
...
snow_types_Config.app_ident = "net.nanjizal.LuxeEmpty";
